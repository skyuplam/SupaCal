...
public class AppointmentTest {
	...
	private SimpleDateFormat formater2 = new SimpleDateFormat("MMMM d - yyyy hh:mm", Locale.ENGLISH);
	...
	public void setUp() throws Exception {
		...
		appointment = new Appointment("title",JanuaryDate,JanuaryDate2,"hong kong","notes",contactList);
		appointment2 = new Appointment("title",JanuaryDate,JanuaryDate2,"hong kong","notes");
	}
	...
	public void testGetStartTime() {
		assertEquals("testGetStartTime",JanuaryDate,appointment.getStartTime());
	}
	...
	public void testSetStartTime() throws ParseException {
		...
		assertEquals("testSetStartTime",DecemberDate,appointment.getStartTime());
	}
	...
	/**
	 * Test method for {@link csit5100.Appointment#setLocation(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link csit5100.Appointment#addAttendees(csit5100.Contact)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link csit5100.Appointment#removeAttendees(csit5100.Contact)}.
	 */
	@Test
	...
	public void testToString() throws ParseException {
		assertEquals("testAddAttendees","(0:00 - 0:00)  title: notes",appointment2.toString());
		Date date = formater2.parse("January 1 - 2010 10:20");
		appointment.setStartTime(date);
		appointment.setEndTime(date);
		assertEquals("testAddAttendees","(10:20 - 10:20)  title: notes",appointment.toString());
	}
