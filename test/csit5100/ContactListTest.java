...
public class ContactListTest {
	...
	public void testAddContact() {
		...
		Contact contact = new Contact("firstName", "lastName", addresses,
				phoneNumbers);
		Contact contact2 = new Contact("firstName2", "lastName2", addresses,
				phoneNumbers);
		Contact contact3 = new Contact("firstName2", "lastName21", addresses,
				phoneNumbers);
	...
	public void testToStrings() {
		...
		Contact contact = new Contact("firstName0", "lastName0", addresses,
				phoneNumbers);
		Contact contact2 = new Contact("firstName1", "lastName1", addresses,
				phoneNumbers);
		contactList.add(contact);
		contactList.add(contact2);
		String[] strs = contactList.toStrings();
		for (int i = 0; i < strs.length; i++)
			assertEquals("The contact should be lastName" + i + ", firstName"
					+ i, "lastName" + i + ", firstName" + i, strs[i]);
	}
